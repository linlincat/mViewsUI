...
const showimageList = computed(() => {
  if (
    props.datas?.rubiksCubeType === 0 &&
    !props.datas?.imageList[0].src &&
    !props.datas?.imageList[1].src
  )
    return false;
  if (
    (props.datas?.rubiksCubeType === 2 ||
      props.datas?.rubiksCubeType === 6 ||
      props.datas?.rubiksCubeType === 3) &&
    !props.datas?.imageList[0].src &&
    !props.datas?.imageList[1].src &&
    !props.datas?.imageList[2].src &&
    !props.datas?.imageList[3].src
  )
    return false;
  return true;
});
